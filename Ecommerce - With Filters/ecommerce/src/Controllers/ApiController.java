...
public class ApiController {
    ...
    private static final String SEARCH_ROUT= "search/";
    private static final String CATEGORIES_ROUT= "categories/";
    private static final String CATEGORY_ROUT= "category/";
