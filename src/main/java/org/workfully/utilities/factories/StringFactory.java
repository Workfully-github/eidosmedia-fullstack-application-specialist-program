...
public class StringFactory {
    ...
    public static final String[] dialogueSelectionFreeOrPremium = { "Is it Free or Premium?", "1 - Free",
            "2 - Premium" };
    ...
    public static final String JSON_PATH = "src/main/java/org/workfully/Sandboxes/homeFeedContents.json";
